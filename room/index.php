...
<body>
	<div class="wrap">
		...
		<div class="logo">
			<a href="/">
		<img src="i/logo.png" alt="" class="logo__img" >	
			</a>
				</div>
    ...
    <nav id="menu">
		...
		<tel>
			<div class="tell">+7-495-018-29-30</div>
			...
			<div class="lend"><a href="eng.php" class="lend__linc"></a></div>	
			...
			<div class="formabox__bg">	
				...
				<div class="input__box"><div class="iconqwest"></div>
					...
					<input  type="submit"  value="Пройти таможню" class="fboot" >
...
<div class="second__scrin__iconimg "> <img src="i/support.png" alt="" bgcolor="pink">	</div>
...
<div class="second__scrin__iconlist">	
Предоставление интересов участника ВЭД при осуществлении осмотров и таможенных досмотровий)
</div>
...
<div class="futer__forma">	
				...
				<form action="mail.php" method="post" class="futer__formabox">
					
					
					
					<div class="futer__input__row__name">
					<div class="futer__input__row__icon"><div class="iconname"></div></div>
					<input type="text" class="futer__input__area" name="fname" value="Ваше имя" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;">
					
					</div>
					
					<div class="futer__input__row__tell">
					<div class="futer__input__row__icon"><div class="ficonemail"></div></div>
					<input type="text" class="futer__input__area" name="ftell" value="Ваш телефон" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;">
					...
					<input  type="submit"  value="Пройти таможню" class="futboot" >
					</div>	
...
<div class="futer__contact">	
	...
	<div class="futer__contact__tell">	+7 921 413-29-29</div>	
	<div class="futer__contact__tell">	+7 911 174-98-40</div>	
</div>
